...
public class GuardedObjectTest {
    public static void main(String[] args){
        ...
        map1.put("TARGETNAME", "8.手术患者并发症发生率▲");
        map1.put("VALUE", "1.42");
        Map<String,Object> map2 = new HashMap<>();
        map2.put("YEAR", "2016");
        map2.put("TARGETID", "t2");
        map2.put("TARGETNAME", "9. I类切口手术部位感染率▲");
        map2.put("VALUE", "1.22");
        Map<String,Object> map3 = new HashMap<>();
        map3.put("YEAR", "2017");
        map3.put("TARGETID", "t3");
        map3.put("TARGETNAME", "8.手术患者并发症发生率▲");
        map3.put("VALUE", "1.23");
        Map<String,Object> map4 = new HashMap<>();
        map4.put("YEAR", "2017");
        map4.put("TARGETID", "t4");
        map4.put("TARGETNAME", "9. I类切口手术部位感染率▲");
        map4.put("VALUE", "1.24");
        Map<String,Object> map5 = new HashMap<>();
        map5.put("YEAR", "2018");
        map5.put("TARGETID", "t5");
        map5.put("TARGETNAME", "8.手术患者并发症发生率▲");
        map5.put("VALUE", "1.52");
        info.add(map1);
        info.add(map2);
        info.add(map3);
